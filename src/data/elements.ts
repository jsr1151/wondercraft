...
export const CORE_ELEMENTS: Element[] = [
  ...
  { id: 'earth', name: 'Earth', category: 'Primordial', emoji: '🟫', description: 'Solid ground', tags: ['solid', 'ground', 'material'], discovered: false, worldEffects: { earthy: 3 } },
  { id: 'air', name: 'Air', category: 'Primordial', emoji: '💨', description: 'The breath of the world', tags: ['gas', 'wind', 'sky'], discovered: false, worldEffects: { atmosphere: 1, air: 3 } },
  ...
  { id: 'cloud', name: 'Cloud', category: 'Nature', emoji: '☁️', description: 'Water vapor floating above', tags: ['sky', 'water', 'weather'], discovered: false, worldEffects: { atmosphere: 1, air: 1 } },
  ...
  { id: 'mountain', name: 'Mountain', category: 'Nature', emoji: '⛰️', description: 'Towering stone highlands', tags: ['stone', 'high', 'land'], discovered: false, worldEffects: { earthy: 2 } },
  ...
  // MATERIALS
  { id: 'stone', name: 'Stone', category: 'Materials', emoji: '🪨', description: 'Solid and enduring', tags: ['solid', 'hard', 'mineral'], discovered: false, worldEffects: { earthy: 1 } },
  ...
  { id: 'sand', name: 'Sand', category: 'Materials', emoji: '🏖️', description: 'Tiny fragments of stone', tags: ['dry', 'small', 'mineral'], discovered: false, worldEffects: { earthy: 1 } },
  ...
  { id: 'clay', name: 'Clay', category: 'Materials', emoji: '🧱', description: 'Malleable earth for shaping', tags: ['soft', 'earth', 'craft'], discovered: false, worldEffects: { earthy: 1 } },
  ...
  { id: 'fog', name: 'Fog', category: 'Weather', emoji: '🌫️', description: 'Mist that obscures vision', tags: ['water', 'air', 'obscure'], discovered: false, worldEffects: { atmosphere: 1, air: 1 } },
  ...
  { id: 'wind', name: 'Wind', category: 'Weather', emoji: '🌬️', description: 'Air in purposeful motion', tags: ['air', 'move', 'weather'], discovered: false, worldEffects: { atmosphere: 1, air: 2 } },
